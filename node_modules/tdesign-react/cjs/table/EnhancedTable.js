...
var defineProperty = require('../_chunks/dep-5951b178.js');
var objectWithoutProperties = require('../_chunks/dep-2ea5b5c6.js');
...
var get = require('../_chunks/dep-b280fd25.js');
...
var EnhancedTable = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _props$tree2;
  var tree = props.tree,
  ...
  var _useTreeData = table_hooks_useTreeData["default"](props),
    ...
    treeInstanceFunctions = objectWithoutProperties._objectWithoutProperties(_useTreeData, _excluded);
  ...
  var primaryTableProps = _objectSpread(_objectSpread(_objectSpread({}, props), {}, {
  ...
  }, table_utils.enableRowDrag(props.dragSort) && {
    rowAttributes: function rowAttributes(params) {
      ...
      if (rowState !== null && rowState !== void 0 && rowState.parent) {
        formatAttrs[table_hooks_useDragSort.DATA_PARENT_ID_ATTR] = String(rowState.parent.id);
      }
      return formatAttrs;
    }
  }), {}, {
  ...
  return /* @__PURE__ */React__default["default"].createElement(table_PrimaryTable["default"], _objectSpread(_objectSpread({}, primaryTableProps), {}, {
    ref: primaryTableRef
  }));
});
